...
namespace LibCalTypes
{
    ...
    public partial class FutureDate
    {
    ...
    public partial class RegistrationsResponse
    {
        [JsonProperty("event_id")]
    ...
    public partial class AppointmentBooking
    {
        ...
        [JsonProperty("answers"), JsonConverter(typeof(AnswerConverter))]
    ...
    class AnswerConverter : JsonConverter<List<QuestionAnswer>>
    {
        ...
        public override List<QuestionAnswer> ReadJson(JsonReader reader, Type objectType, List<QuestionAnswer> existingValue, bool hasExistingValue,
            JsonSerializer serializer)
        {
            // Answers is either an object containing question ids and answers, or an empty array.
    ...
    public partial class AppointmentQuestion
    {
        ...
        [JsonProperty("options", NullValueHandling = NullValueHandling.Ignore), JsonConverter(typeof(OptionConverter))]
    ...
    class OptionConverter : JsonConverter<List<QuestionOption>>
    {
        ...
        public override List<QuestionOption> ReadJson(JsonReader reader, Type objectType, List<QuestionOption> existingValue, bool hasExistingValue,
            JsonSerializer serializer)
        {
            var options = serializer.Deserialize<List<string>>(reader) ?? throw new Exception("Failed to deserialize options");
